...
<input type="hidden" name="mode" value="Packages"  />
	...
	<tr class="header">
      ...
      <TMPL_LOOP NAME="package_list">
		...
		<td><a href="astpp-admin.cgi?mode=Packages&action=Edit...&id=<TMPL_VAR NAME="id">"><img alt='Edit' src='../../_astpp/edit.jpg'></a>
			<a href="astpp-admin.cgi?mode=Packages&action=Deactivate...&id=<TMPL_VAR NAME="id">"><img alt='Delete' src='../../_astpp/delete.jpg'></a></td>
	       </TD>
            </TR>
      </TMPL_LOOP> 
</table>
