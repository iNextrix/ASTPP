...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'card_retries', 'How many retries do we allow for calling card numbers?',
'3', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'pin_retries', 'How many retries do we allow for pins?',
'3', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'number_retries', 'How many retries do we allow calling card users when dialing a number?',
'3', '');
