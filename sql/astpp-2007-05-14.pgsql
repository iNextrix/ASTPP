...
--
-- Sequences for table ROUTES
--

CREATE SEQUENCE routes_id_seq;

CREATE TABLE routes (
id INTEGER DEFAULT nextval('routes_id_seq') PRIMARY KEY,
pattern CHAR(40),
comment CHAR(80),
...
--
-- Sequences for table CALLINGCARDCDRS
--

CREATE SEQUENCE callingcardcdrs_id_seq;

CREATE TABLE callingcardcdrs (
id INTEGER DEFAULT nextval('callingcardcdrs_id_seq') PRIMARY KEY,
...
status INTEGER DEFAULT 1 NOT NULL,
dialed_modify TEXT DEFAULT '' NOT NULL DEFAULT '',
resellers TEXT DEFAULT '' NOT NULL DEFAULT '',
precedence INT4 NOT NULL DEFAULT 0,
...
--
-- Sequences for table OUTBOUND_ROUTES
--

CREATE SEQUENCE outbound_routes_id_seq;

CREATE TABLE outbound_routes (
pattern CHAR(40),
id INTEGER DEFAULT nextval('outbound_routes_id_seq') PRIMARY KEY,
...
CREATE TABLE dids (
number CHAR(40) NOT NULL PRIMARY KEY,
...
prorate INT4 NOT NULL DEFAULT 0,
setup INT4 NOT NULL DEFAULT 0,
limittime INT4 NOT NULL DEFAULT 1,
disconnectionfee INT4 NOT NULL DEFAULT 0,
variables TEXT DEFAULT '' NOT NULL DEFAULT '',
options varchar(40) DEFAULT NULL);

CREATE TABLE accounts (
cc CHAR(20) NOT NULL DEFAULT '',
number CHAR(50) PRIMARY KEY,
reseller CHAR(40) NOT NULL DEFAULT '',
...
routing_technique INT4 NOT NULL DEFAULT 0,
dialed_modify TEXT DEFAULT '' NOT NULL DEFAULT '',
...
--
-- Sequences for table COUNTERS
--

CREATE SEQUENCE counters_id_seq;

CREATE TABLE counters (
id INTEGER DEFAULT nextval('counters_id_seq') PRIMARY KEY,
...
--
-- Sequences for table CALLINGCARDS
--

CREATE SEQUENCE callingcards_id_seq;

CREATE TABLE callingcards (
id INTEGER DEFAULT nextval('callingcards_id_seq') PRIMARY KEY,
...
--
-- Sequences for table CHARGE_TO_ACCOUNT
--

CREATE SEQUENCE charge_to_account_id_seq;

CREATE TABLE charge_to_account (
id INTEGER DEFAULT nextval('charge_to_account_id_seq') PRIMARY KEY,
...
--
-- Sequences for table QUEUE_LIST
--

CREATE SEQUENCE queue_list_id_seq;

CREATE TABLE queue_list (
id INTEGER DEFAULT nextval('queue_list_id_seq') PRIMARY KEY,
...
--
-- Sequences for table PBX_LIST
--

CREATE SEQUENCE pbx_list_id_seq;

CREATE TABLE pbx_list (
id INTEGER DEFAULT nextval('pbx_list_id_seq') PRIMARY KEY,
...
--
-- Sequences for table EXTENSION_LIST
--

CREATE SEQUENCE extension_list_id_seq;

CREATE TABLE extension_list (
id INTEGER DEFAULT nextval('extension_list_id_seq') PRIMARY KEY,
...
--
-- Sequences for table CDRS
--

CREATE SEQUENCE cdrs_id_seq;

CREATE TABLE cdrs (
id INTEGER DEFAULT nextval('cdrs_id_seq') PRIMARY KEY,
uniqueid varchar(32) NOT NULL DEFAULT '',
cardnum CHAR(50),
callerid CHAR(80),
...
--
-- Sequences for table PACKAGES
--

CREATE SEQUENCE packages_id_seq;

CREATE TABLE packages (
id INTEGER DEFAULT nextval('packages_id_seq') PRIMARY KEY,
...
--
-- Sequences for table CHARGES
--

CREATE SEQUENCE charges_id_seq;

CREATE TABLE charges (
id INTEGER DEFAULT nextval('charges_id_seq') PRIMARY KEY,
pricelist CHAR(40) NOT NULL DEFAULT '',
...
--
-- Sequences for table MANAGER_ACTION_VARIABLES
--

CREATE SEQUENCE manager_action_variables_id_;

CREATE TABLE manager_action_variables (
id INTEGER DEFAULT nextval('manager_action_variables_id_') PRIMARY KEY,
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'callingcards_callback_extension', 's',
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'openser', '0',
'Use OPENSER?  1 for yes or 0 for no', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'openser_dbname', '0',
'OPENSER Database Name', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'openser_dbuser', '0',
'OPENSER Database User', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'openser_dbhost', '0',
'OPENSER Database Host', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'openser_dbpass', '0',
'OPENSER Database Password', '');
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'company_email', 'email@astpp.org',
'Email address that email should appear to be from', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'asterisk_dir', '/etc/asterisk',
'Which directory are asterisk configuration files stored in?', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'company_website', 'http://www.astpp.org',
'Link to your company website', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'company_name', 'ASTPP.ORG',
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'user_email', '1',
'Email user on account changes? 0=no 1=yes', '');
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'enablelcr', '1',
'Use least cost routing 0=no 1=yes', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'log_file', '/var/log/astpp/astpp.log',
'ASTPP Log file', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'key_home', 'http://www.astpp.org/astpp.pub',
'Asterisk RSA Key location (optional)', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'rate_engine_csv_file', '/var/log/astpp/astpp.csv',
'CSV File for call rating data', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'csv_dir', '/var/log/astpp/',
'CSV File Directory', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'default_brand', 'DEFAULT',
'Default pricelist.  If a price is not found in the customers pricelist we check this one.', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'new_user_brand', 'DEFAULT',
'What is the DEFAULT pricelist for new customers?', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'default_context', 'custom-astpp',
'What is the DEFAULT context for new devices?', '');
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'asterisk_server', 'voip.astpp.org',
'Your DEFAULT voip server.  Used in outgoing email.', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'currency', 'CAD',
'Name of the currency you use', '');
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'ipaddr', 'dynamic',
'Default IP Address for new devices', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'key', 'astpp.pub',
'Asterisk RSA Key Name (Optional)', '');
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'credit_limit', '0',
'Default credit limit in dollars.', '');
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'max_free_length', '100',
'What is the maximum lenght (in minutes) of calls that are at no charge?', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'trackvendorcharges', '1',
'Do we track the amount of money we spend with specific providers? 0=no 1=yes', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'company_logo', 'http://www.astpp.org/logo.png',
'', '');

INSERT INTO system (name, value, comment, timestamp) VALUES (
'company_slogan', 'Welcome to ASTPP',
'', '');
...
INSERT INTO system (name, value, comment, timestamp) VALUES ('results_per_page','30','How many results per page do we should in the web interface?','');
...
CREATE TABLE `resellers` (
  ...
  posttoexternal INT4 NOT NULL DEFAULT '0',
  agile_site_id INT4 NOT NULL DEFAULT '0',
...
id INTEGER DEFAULT nextval('templates_id_seq') PRIMARY KEY,
name VARCHAR(45) NOT NULL DEFAULT '',
reseller VARCHAR(45) NOT NULL DEFAULT '',
template TEXT DEFAULT '' NOT NULL DEFAULT ''
);
...
--
-- Sequences for table RESELLER_PRICING
--

CREATE SEQUENCE reseller_pricing_id_seq;

CREATE TABLE reseller_pricing (
id INTEGER DEFAULT nextval('reseller_pricing_id_seq') PRIMARY KEY,
...
--
-- Sequences for table CALLSHOPS
--

CREATE SEQUENCE callshops_id_seq;

CREATE TABLE callshops (
id INTEGER DEFAULT nextval('callshops_id_seq') PRIMARY KEY,
...
--
-- Indexes for table CDRS
--

CREATE UNIQUE INDEX varchar_cdrs_index ON cdrs (32);

--
-- Indexes for table CALLINGCARDCDRS
--

CREATE UNIQUE INDEX VARCHAR_callingcardcdrs_index ON callingcardcdrs (32);

--
-- Sequences for table MANAGER_ACTION_VARIABLES
--

SELECT SETVAL('manager_action_variables_id_',(select case when max(id)>0 then max(id)+1 else 1 end from manager_action_variables));

--
-- Sequences for table RESELLER_PRICING
--

SELECT SETVAL('reseller_pricing_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from reseller_pricing));

--
-- Sequences for table CHARGES
--

SELECT SETVAL('charges_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from charges));

--
-- Sequences for table CALLINGCARDCDRS
--

SELECT SETVAL('callingcardcdrs_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from callingcardcdrs));

--
-- Sequences for table ROUTES
--

SELECT SETVAL('routes_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from routes));

--
-- Sequences for table CALLINGCARDS
--

SELECT SETVAL('callingcards_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from callingcards));

--
-- Sequences for table CDRS
--

SELECT SETVAL('cdrs_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from cdrs));

--
-- Sequences for table CALLSHOPS
--

SELECT SETVAL('callshops_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from callshops));

--
-- Sequences for table QUEUE_LIST
--

SELECT SETVAL('queue_list_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from queue_list));

--
-- Sequences for table PBX_LIST
--

SELECT SETVAL('pbx_list_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from pbx_list));

--
-- Sequences for table COUNTERS
--

SELECT SETVAL('counters_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from counters));

--
-- Sequences for table CHARGE_TO_ACCOUNT
--

SELECT SETVAL('charge_to_account_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from charge_to_account));

--
-- Sequences for table PACKAGES
--

SELECT SETVAL('packages_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from packages));

--
-- Sequences for table OUTBOUND_ROUTES
--

SELECT SETVAL('outbound_routes_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from outbound_routes));

--
-- Sequences for table EXTENSION_LIST
--

SELECT SETVAL('extension_list_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from extension_list));

--
-- Sequences for table TEMPLATES
--

SELECT SETVAL('templates_id_seq',(select case when max(id)>0 then max(id)+1 else 1 end from templates));
