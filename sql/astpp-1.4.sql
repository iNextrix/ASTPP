...
CREATE TABLE callingcardbrands (name CHAR(40) PRIMARY KEY, 
...
CREATE TABLE callingcardcdrs (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
CREATE TABLE trunks (name VARCHAR(30) PRIMARY KEY, 
...
CREATE TABLE outbound_routes (pattern CHAR(40), 
id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
CREATE TABLE dids (number CHAR(40) NOT NULL PRIMARY KEY,
...
limittime int(1) NOT NULL default 0,
options varchar(40) default NULL);

CREATE TABLE accounts (cc CHAR(20) NOT NULL DEFAULT '', 
...
CREATE TABLE counters (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
package CHAR(40) NOT NULL DEFAULT '', 
account VARCHAR(50) NOT NULL, 
seconds INTEGER NOT NULL DEFAULT 0);

CREATE TABLE callingcards (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
CREATE TABLE charge_to_account (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
charge_id INTEGER NOT NULL DEFAULT 0,
cardnum CHAR(50) NOT NULL DEFAULT '', 
status INTEGER NOT NULL DEFAULT 1);

CREATE TABLE queue_list (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
queue_id INTEGER NOT NULL DEFAULT 0,
cardnum CHAR(20) NOT NULL DEFAULT '');

CREATE TABLE pbx_list (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
pbx_id INTEGER NOT NULL DEFAULT 0,
cardnum CHAR(20) NOT NULL DEFAULT '');

CREATE TABLE extension_list (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
CREATE TABLE cdrs (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
CREATE TABLE packages (id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
CREATE TABLE ani_map (number CHAR(20) NOT NULL PRIMARY KEY, 
account CHAR(50) NOT NULL DEFAULT '', 
status INTEGER DEFAULT 0 NOT NULL);
...
INSERT INTO system (name, value, comment, timestamp) VALUES (
'currency_name', 'Canadian Dollars(CAD)',
...
CREATE TABLE `invoice` (
  `invoiceno` int(11) unsigned NOT NULL auto_increment,
  `uid` int(10) unsigned NOT NULL default '0',
  `invoice_date` date NOT NULL,
  `due_date` date NOT NULL,
  `kid` varchar(128) default NULL,
  `period` varchar(128) default NULL,
  `invfooter` varchar(1024) default NULL,
  ...
  KEY `inv_db_prefix` (`uid`,`invoiceno`)
);

CREATE TABLE `invoicedetail` (
  `invoiceno` int(11) unsigned NOT NULL,
  ...
  PRIMARY KEY  (`lineno`),
  UNIQUE KEY `invid` (`invoiceno`,`lineno`)
...
INSERT INTO `userlevelpermissions` (`userlevelid`,`tablename`,`permission`) VALUES 
 (0,'accounts',0),
 (0,'ani_map',0),
 (0,'callingcardbrands',0),
 (0,'callingcardcdrs',0),
 (0,'callingcards',0),
 (0,'cdrs',0),
 (0,'charges',0),
 (0,'charge_to_account',0),
 (0,'counters',0),
 (0,'countrycode',0),
 (0,'currency',0),
 (0,'CustomerDID',0),
 ...
 (0,'system',0),
 (0,'trunks',0),
 (0,'userlevelpermissions',0),
 (0,'userlevels',0),
 (2,'accounts',15),
 (2,'ani_map',15),
 (2,'callingcardbrands',15),
 (2,'callingcardcdrs',15),
 (2,'callingcards',15),
 (2,'cdrs',15),
 (2,'charges',15),
 (2,'charge_to_account',15),
 (2,'counters',15),
 (2,'dids',15),
 (2,'extension_list',15),
 (2,'ip_map',15),
 (2,'outbound_routes',15);
INSERT INTO `userlevelpermissions` (`userlevelid`,`tablename`,`permission`) VALUES 
 (2,'packages',15),
 (2,'pbx_list',15),
 (2,'pricelists',15),
 ...
 (5,'accounts',12),
 (5,'ani_map',12),
 (5,'callingcardbrands',0),
 (5,'callingcardcdrs',0),
 (5,'callingcards',8),
 (5,'cdrs',8),
 (5,'charges',0),
 (5,'charge_to_account',8),
 (5,'counters',0),
 (5,'countrycode',0),
 (5,'dids',8),
 (5,'extension_list',0),
