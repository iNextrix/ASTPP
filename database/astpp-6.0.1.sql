...
--ASTPPCOM-1418 Ankit Start
INSERT INTO `default_templates` VALUES (NULL,'daily_career_performance_report','Daily Carrier Performance Report #DATE#','Daily Carrier Performance Report','','','<p>Dear #NAME#,<br/>Please find below the daily performance summary for your carrier account dated #DATE#:<br/>Total Consumption (Today): #UTILIZED_BALANCE#<br/>Remaining Balance: #REMAINING_BALANCE#<br/>This report is automatically generated by #COMPANY_NAME# for your convenience and is sent daily at 08:00 PM IST.<br/>If you have any questions or need further assistance, please feel free to reach out to us.<br/><br/>Warm regards,<br/>#COMPANY_NAME#<br/>#COMPANY_EMAIL#</p>','2025-05-26 10:53:45',0,0,0,0,0);

insert into cron_settings values(NULL,'Daily Career Report','days','1','2025-05-10 18:30:00','2025-05-10 18:30:00','2025-05-10 18:30:01','2025-05-11 18:30:01','0','wget --no-check-certificate -O - -q {BASE_URL}dailyBalanceReport/send_daily_balance_email/');
-- ASTPPCOM-1418 Ankit End
