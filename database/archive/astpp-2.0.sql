...
INSERT INTO `accounts` VALUES (1,'admin',0,0,0,10000.00000,2,'2014-12-25 08:45:12',0.00000,0,0.00000,'admin','Administrator','','Your Company','ADDRESS','','','','',85,'','','your@email.com',1,139,1,'',-1,27,0,0,0,0,'0',0,0,'','1980-01-01 00:00:00','1980-01-01 00:00:00',60000),(2, '7335503421', 0, 1, 0, '0.00000', 2, '2015-01-23 13:22:50', '0.00000', 0, '1.00000', '7335503421', 'IPComms', 'SIPTrunk', 'IPComms', '1925 Vaughn Rd', '', '30144', 'Georgia', 'Kennesaw', 203, '+1.678.460.4302', '+1.678.460.1475', 'no-reply@ipcomms.net', 0, 139, 0, '', 3, 8, 0, 0, 0, 1, '', 0, 1, '7335503421','1980-01-01 00:00:00', '1980-01-01 00:00:00', 0),(3,'2457848300',0,1,0,0.00000,2,'2015-01-23 13:25:15',0.00000,0,0.00000,'2457848300','customer','','ASTPP','','','','','',71,'','','customer@astpp.org',0,139,0,'',0,26,0,0,0,1,'',0,23,'2457848300','1980-01-01 00:00:00','2025-01-23 13:24:12',0);
...
CREATE TABLE `default_templates` (
  ...
  `modified_date` datetime NOT NULL DEFAULT '1980-01-01 00:00:00',
  PRIMARY KEY (`id`)
...
INSERT INTO `gateways` VALUES (1,1,'IPComms','{\"username\":\"USERNAME\",\"password\":\"PASSWORD\",\"proxy\":\"siptrunk.ipcomms.net\",\"register\":\"false\",\"caller-id-in-from\":\"true\"}','2015-01-23 13:20:54','1980-01-01 00:00:00',0,0);
...
ALTER TABLE `taxes` CHANGE `last_modified` `last_modified` DATETIME NOT NULL DEFAULT '1980-01-01 00:00:00';
ALTER TABLE `taxes` CHANGE `date_added` `date_added` DATETIME NOT NULL DEFAULT '1980-01-01 00:00:00';
