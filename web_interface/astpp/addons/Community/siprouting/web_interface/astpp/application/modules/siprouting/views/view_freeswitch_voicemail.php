...
<div class="w-section inverse p-0">
	<form method="post" name='voicemail_form' id ="voicemail_id" enctype="multipart/form-data" action="<?= base_url()?>siprouting/fssipdevices_voice_mail_save/">
		...
		<?php //Nirali issue 3898 END ?>
			...
			<a href="javascript:history.go(-1)" class="btn text-primary" onclick="return redirect_page('/freeswitch/fssipdevices/')"><?php echo gettext("Cancel"); ?></a>	
