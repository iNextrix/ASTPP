...
(function ($) {
    ...
    setMenuSize: function (isAuto) {
      ...
      if (this.options.size === 'auto') {
        ...
        if (this.$newElement.hasClass(classNames.DROPUP)) {
          ...
          $(".bootstrap-select.dropup .dropdown-menu[role='combobox']").removeClass("bs-select");
        }else{
          $(".bootstrap-select .dropdown-menu[role='combobox']").addClass("bs-select");
        }
  ...
  $(document)
    ...
    .on('keydown' + EVENT_KEY, '.bootstrap-select [data-toggle="dropdown-menu"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', Selectpicker.prototype.keydown)
    .on('focusin.modal', '.bootstrap-select [data-toggle="dropdown-menu"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', function (e) {
      e.stopPropagation();
    });
