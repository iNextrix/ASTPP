 ...
 */
// ------------------------------------------------------------------------
if ( ! function_exists('get_paramter'))
{
	function get_paramter($field_no,$field_match='')
	{
		$CI =& get_instance();
		if ($CI->uri->segment($field_no) === FALSE)
		{	
			return '';
		}
		if($field_match != '')
		{
			if($CI->uri->segment($field_no) != $field_match)
			{
				return '';
			}
		}
		return $CI->uri->segment($field_no);
	}
}
if ( ! function_exists('variable_value'))
{
