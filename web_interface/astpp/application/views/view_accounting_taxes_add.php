...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">                        
    ...
    <div class="portlet-content">
        <form method="post" action="<?= base_url() ?><?= isset($tax_id) ? "accounting/account_taxes/edit" : "accounting/account_taxes/add" ?>" enctype="multipart/form-data">                
                        ...
                        <li>
                            ...
                            if (isset($taxesList) && is_array($taxesList) && count($taxesList) > 0) {
                                ...
                                <td style="padding-left: 10px;">
                                    <input type="checkbox" id="tax_<?= $values->taxes_id; ?>"name="tax_<?= $values->taxes_id; ?>" value="<?= $values->taxes_id; ?>" <? if (in_array($values->taxes_id, $tax_ids)) {
                                echo "checked";
