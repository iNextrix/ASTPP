...
<footer class="site-footer"> 
  ...
  <?php
	if($this->session->userdata['logintype'] == 2){ ?>
	    <div  class="pull-left padding-l-20"><span style="color:#4C4C4C;">Powered by </span><a href="http://www.astpp.org" target="_blank"><span style="color: #216397;text-shadow: 0px 1px 1px #FFF;"><strong>ASTPP</strong></span></a>
