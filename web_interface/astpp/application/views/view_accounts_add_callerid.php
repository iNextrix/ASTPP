<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
  <div class="portlet-header ui-widget-header">ADD CallerID<span class="ui-icon ui-icon-circle-arrow-s"></span></div>
   
  <div class="portlet-content">
  <form method="post" action="<?=base_url()?>accounts/add_callerid" id="frm_payment_process" enctype="multipart/form-data">  
  ...
  <?php }?>	
  <input type="hidden" name="accountid" value="<? echo $account_id?>"/>
  <ul style="width:600px;">
      <li>
          <label class="desc">Account Number:</label>
          <label class="desc" style="text-align: left; padding-left: 5px;"><? echo $account?></label>
      </li>
      <li>
