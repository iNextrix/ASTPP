...
$("#flex1").flexigrid({
    url: "<?php echo base_url();?>switchconfig/fssipdevices_grid/",
    method: 'GET',
    dataType: 'json',
	colModel : [
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">                        
            <div class="portlet-header ui-widget-header">Freeswitch(TM) SIP Devices<span class="ui-icon ui-icon-circle-arrow-s"></span></div>
