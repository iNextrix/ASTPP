...
$("#flex1").flexigrid({
    url: "<?php echo base_url();?>accounts/search_fssipdevices_account_list/grid/",
    method: 'GET',
    dataType: 'json',
	colModel : [
...
$("#id_filter").click(function(){
	...
	flex_url = "<?php echo base_url();?>accounts/search_fssipdevices_account_list/grid/"+account+"/"+company+"/"+fname+"/"+lname;
	//alert(flex_url);
...
function sendValue(selvalue, othervalue){
	window.opener.document.form19.account_number.value = selvalue;
	if(othervalue && window.opener.document.form19.accountcode){
			window.opener.document.form19.accountcode.value = othervalue;
	}
	window.close();
}
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">                        
    <div class="portlet-header ui-widget-header">Account List<span class="ui-icon ui-icon-circle-arrow-s"></span></div>
    <div class="portlet-content">         
