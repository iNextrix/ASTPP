...
$("#flex1").flexigrid({
    url: "<?php echo base_url();?>opensipsconfig/dispatcher_grid/",
    method: 'GET',
    dataType: 'json',
	colModel : [
	{display: 'Setid', name: 'Setid', width: 120, sortable: false, align: 'center'},
	{display: 'Destination', name: 'destination', width: 120, sortable: false, align: 'center'},
	{display: 'Flags', name: 'Flags', width: 120, sortable: false, align: 'center'},
        {display: 'Weight', name: 'weight', width: 100, sortable: false, align: 'center'},
        {display: 'Attrs', name: 'Attrs', width: 120, sortable: false, align: 'center'},
	{display: 'Description', name: 'description', width: 100, sortable: false, align: 'center'},
...
function add_button()
{
	jQuery.facebox({ ajax: '<?php echo base_url();?>opensipsconfig/dispatcher/add'});
}
