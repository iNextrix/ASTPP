...
function build_packages_list_for_user(){
    ...
    function build_refill_list_for_user() {
      $grid_field_arr = json_encode(array(
            ...
            array("Refill By", "230", "payment_by", "payment_by", "payment_by", "get_refill_by"),
    ...
    function build_emails_list_for_user() {
        $grid_field_arr = json_encode(array(
            array("Date", "110", "date", "", "", "","","true","center"),
            array("From", "170", "from", "", "", "","","true","center"),
            array("Body", "550", "body", "", "", "","","true","center"),
            array("Attachement", "100", "attachment", "attachment", "attachment", "attachment_icons","","true","center"),
 ...
 'class' => "text field "), '', 'tOOL TIP', '', 'date[date-date]'),
        ...
        $form['button_search'] = array('name' => 'action', 'id' => "user_email_search_btn", 'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
    ...
    function get_userprofile_form_fields($dataArr = false) {
        if ($dataArr['id'] > 0)
            ...
            array('Account Number', 'INPUT', array('name' => 'number', 'value' => $uname, 'size' => '20', 'readonly' => true,  'class' => "text field medium"), '', 'tOOL TIP', 'Please Enter account number'),
            array('Pin', 'INPUT', array('name' => 'pin', 'size' => '20', 'class' => "text field medium"),  'tOOL TIP', ''),
            array('Company', 'INPUT', array('name' => 'company_name', 'size' => '15', 'class' => 'text field medium'), 'trim|xss_clean', 'tOOL TIP', ''),
            array('First Name', 'INPUT', array('name' => 'first_name', 'id' => 'first_name', 'size' => '15',  'class' => "text field medium"), 'trim|required|xss_clean', 'tOOL TIP', 'Please Enter account number'),
            ...
            array('Email', 'INPUT', array('name' => 'email', 'size' => '50',  'class' => "text field medium"), 'required|valid_email|is_unique[' . $val . ']', 'tOOL TIP', 'Please Enter Password'),
     ...
     function get_userprofile_change_password() {
        ...
        $form['Change Password'] = array(
            array('', 'HIDDEN', array('name' => 'id'), '', '', '', ''),
            array('Old Password', 'INPUT', array('name' => 'password', 'size' => '20', 'class' => "text field medium", 'id' => 'new_password'), 'required|password_check[accounts]', 'tOOL TIP', '', ''),
            array('New Password', 'INPUT', array('name' => 'new_password', 'size' => '20', 'class' => "text field medium", 'id' => 'new_password'), 'required|', 'tOOL TIP', '', ''),
            array('Confirm Password', 'INPUT', array('name' => 'new_confirm_password', 'size' => '20',  'class' => "text field medium", 'id' => 'password'), "required|matches[new_password]", 'tOOL TIP', '', ''),
        );
        $form['button_save'] = array('name' => 'action', 'content' => 'Save', 'value' => 'save', 'type' => 'submit', 'class' => 'btn btn-line-parrot');
        return $form;
    }
    ...
    function build_user_invoices(){
      ...
      $grid_field_arr  = json_encode(array(
          ...
          array("Type","100","id","id,'',type","invoices","build_concat_string","","true","center"),
          array("Generated Date","110","invoice_date","invoice_date","","get_invoice_date","","true","center"),
		  array("From Date","100","from_date","from_date","","get_from_date","","true","center"),
		  array("Due Date","100","","","","","","true","center"),
		  array("Last Pay Date","100","","","","","","true","center"),
		  array("Amount($currency)","100","id","id","id","get_invoice_total","","true","right"),
		  array("Outstanding Amount<br>($currency)","150","","","","","","true","right"),
    ...
    function build_user_invoices_search()
    {
	    ...
	    array('To Date', 'INPUT', array('name' => 'to_date[1]','id'=>'invoice_to_date','size' => '20', 'class' => "text field"), '', 'tOOL TIP', '', 'to_date[to_date-date]'),
	    ...
	    array('', 'HIDDEN', 'ajax_search','1', '', '', ''),    
        array('', 'HIDDEN', 'advance_search','1', '', '', ''));
        $form['button_search'] = array('name' => 'action', 'id'=>"user_invoice_search_btn",'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
        $form['button_reset'] = array('name' => 'action','id'=>"id_reset", 'content' => 'Clear', 'value' => 'cancel', 'type' => 'reset', 'class' => 'btn btn-line-sky pull-right margin-x-10');
        return $form;
    }
    ...
    function build_user_charge_history_search() {
        $form['forms'] = array("", array('id' => "user_charge_history_search"));
        $form['Search'] = array(
    ...
    function build_user_subscription(){
		 ...
		 $currency=$this->CI->common->get_field_name('currency', 'currency', $currency_id);
         $grid_field_arr = json_encode(array(
			array("Name", "335", "description", "", "", "","","true","center"),
            array("Amount($currency)", "335", "charge", "charge", "charge", "convert_to_currency","","true","right"),
            array("Billing Cycle", "335", "sweep_id", "sweep", "sweeplist", "get_field_name","","true","center"),
                ));
        return $grid_field_arr;
    }
    ...
    function build_user_subscription_search() {
        ...
        $form['forms'] = array("", array('id' => "user_subscription_search"));
        $form['Search'] = array(
        ...
        $form['button_search'] = array('name' => 'action', 'id' => "user_subscriptions_button", 'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
        $form['button_reset'] = array('name' => 'action', 'id' => "id_reset", 'content' => 'Clear', 'value' => 'cancel', 'type' => 'reset', 'class' => 'btn btn-line-sky pull-right margin-x-10');
    ...
    function build_user_didlist() {
		...
		$currency=$this->CI->common->get_field_name('currency', 'currency', $currency_id);
        $grid_field_arr = json_encode(array(
			array("DID", "105", "number", "", "", "","","true","center"),
			array("Country", "90", "country_id", "country", "countrycode", "get_field_name","","true","center"),
			array("Per Minute<br/>Cost($currency)", "90", "cost", "cost", "cost", "convert_to_currency","","true","right"),
			array("Initial<br/>Increment", "100", "init_inc", "", "", "","","true","center"),
            array("Increment", "100", "inc", "", "", "","","true","center"),
            array("Setup<br/>Fee($currency)", "100", "setup", "setup", "setup", "convert_to_currency","","true","right"),
            array("Monthly<br/>Fee($currency)", "100", "monthlycost", "monthlycost", "monthlycost", "convert_to_currency","","true","right"),
            array("Call Type", "105", "call_type", "call_type", "call_type", "get_call_type","","true","center"),
            array("Destination", "153", "extensions", "", "", "","","true","center"),
            array("Status", "90", "status", "status", "dids", "get_did_status","","true","center"),
            array("Modified <br/>Date", "100", "last_modified_date", "last_modified_date", "last_modified_date", "convert_GMT_to","","true","center"),
            array("Action", "80", "", "", "", array("EDIT" => array("url" => "/user/user_did_edit/", "mode" => "popup"),
     ...
     function build_user_didlist_search() {
             $form['forms'] = array("", array('id' => "user_did_search"));
             $form['Search'] = array(
        ...
        $form['button_search'] = array('name' => 'action', 'id' => "user_did_search_btn", 'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
        $form['button_reset'] = array('name' => 'action', 'id' => "id_reset", 'content' => 'Clear', 'value' => 'cancel', 'type' => 'reset', 'class' => 'btn btn-line-sky pull-right margin-x-10');
    ...
    function build_user_ipmap() {
        $grid_field_arr = json_encode(array(
            array("Name", "240", "name", "", "", "","","true","center"),
            array("IP", "240", "ip", "", "", "","","true","center"),
            array("Prefix", "220", "prefix", "", "", "","","true","center"),
            array("Created Date", "174", "created_date", "created_date", "created_date", "convert_GMT_to","","true","center"),
            array("Action", "150", "", "", "", array("DELETE" => array("url" => "user/user_ipmap_action/delete/", "mode" => "single")))
                ));
        return $grid_field_arr;
    }
    
    function build_user_ipmap_search() {
        $form['forms'] = array("", array('id' => "user_ipmap_search"));
        $form['Search'] = array(
        ...
        $form['button_search'] = array('name' => 'action', 'id' => "user_ipmap_search_btn", 'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
		$form['button_reset'] = array('name' => 'action', 'id' => "id_reset", 'content' => 'Clear', 'value' => 'cancel', 'type' => 'reset', 'class' => "btn btn-line-sky pull-right margin-x-10");
        return $form;
    }
    ...
    function build_user_sipdevices(){
	    ...
	    array("<input type='checkbox' name='chkAll' class='ace checkall'/><label class='lbl'></label>", "30", "", "", "", "","","false","center"),
            array("User Name", "105", "username", "", "", "","","true","center"),
            array("Password", "105", "password", "", "", "","","true","center"),
            array("Caller Name", "110", "effective_caller_id_name", "", "", "","","true","center"),
            array("Caller Number", "110", "effective_caller_id_number", "", "", "","","true","center"),      
            array("Status", "125", "status", "", "", "","","true","center"),
            array("Created Date", "110", "creation_date", "creation_date", "creation_date", "convert_GMT_to","","true","center"),
            array("Modified Date", "130", "last_modified_date", "last_modified_date", "last_modified_date", "convert_GMT_to","","true","center"),
            array("Voicemail", "90", "voicemail_enabled", "", "", "","","true","center"),
            array("Action", "110", "", "", "", array("EDIT" => array("url" => "/accounts/fssipdevices_action/edit/", "mode" => "single","layout"=>"medium"),
    ...
    function build_user_sipdevices_search(){
        ...
        $form['button_search'] = array('name' => 'action', 'id' => "user_sipdevices_search_btn", 'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
        $form['button_reset'] = array('name' => 'action', 'id' => "id_reset", 'content' => 'Clear', 'value' => 'cancel', 'type' => 'reset', 'class' => 'btn btn-line-sky pull-right margin-x-10');
        return $form;
    }
	...
	$uname_user = $this->CI->common->find_uniq_rendno('10', '', '');
        ...
        $form['Device Information'] = array(
            ...
            array('Password', 'INPUT', array('name' => 'fs_password', 'size' => '20', 'value'=>$password ,'id'=>'password','class' => "text field medium"), 'trim|required|xss_clean', 'tOOL TIP', 'Please Enter Password','<i style="color: #1BCB61;font-size: 14px;padding-left: 5px;padding-top: 8px;float: left;" title="Reset Password" class="change_pass fa fa-refresh"></i>'),
        ...
        $form['Voicemail Options'] = array(
            array('Enable', 'voicemail_enabled', 'SELECT', '', '', 'tOOL TIP', 'Please Select Status', '', '', '', 'set_sip_config_option'),
	    ...
	    array('Mail To', 'INPUT', array('name' => 'voicemail_mail_to', 'size' => '20', 'class' => "text field medium"), '', 'tOOL TIP', 'Please Enter account number'),
            array('Attach File', 'voicemail_attach_file', 'SELECT', '', '', 'tOOL TIP', 'Please Select Status', '', '', '', 'set_sip_config_option'),
            array('Local After Email', 'vm_keep_local_after_email', 'SELECT', '', '', 'tOOL TIP', 'Please Select Status', '', '', '', 'set_sip_config_option'),
            array('Send all Message', 'vm_send_all_message', 'SELECT', '', '', 'tOOL TIP', 'Please Select Status', '', '', '', 'set_sip_config_option'),
    ...
    function build_user_animap() {
        $grid_field_arr = json_encode(array(array("Caller ID", "735", "number", "", "", "","","true","center"),
            array("Action", "275", "", "", "", array("DELETE" => array("url" => "user/user_animap_action/delete/", "mode" => "single")))
                ));
        return $grid_field_arr;
    }
    ...
    function user_rates_list_buttons() {
        $buttons_json = json_encode(array(
            array("Export CSV","btn btn-xing" ,"fa fa-download fa-lg", "button_action", "/user/user_rates_list_export/", 'single')
        ));
        return $buttons_json;
    }
    ...
    function user_rates_list() {
         ...
         $currency_id=$account_info['currency_id'];
         $currency=$this->CI->common->get_field_name('currency', 'currency', $currency_id);
         $grid_field_arr = json_encode(array(array("Code", "155", "pattern", "pattern", "", "get_only_numeric_val","","true","center"),
	      array("Destination", "200", "comment", "", "", "","","true","center"),
	      array("Connect Cost($currency)", "200", "connectcost", "", "", "","","true","right"),
	      array("Included Seconds", "200", "includedseconds", "", "", "","","true","center"),
	      array("Per Minute Cost($currency)", "200", "cost", "", "", "","","true","right"),
	      array("Initial Increment", "130", "init_inc", "", "", "","","true","center"),
	      array("Increment", "180", "inc", "", "", "","","true","center")
	));
        return $grid_field_arr;
    }
    
    function user_rates_list_search() {
        $form['forms'] = array("", array('id' => "user_rates_list_search"));
        $form['Search'] = array(
        ...
        $form['button_search'] = array('name' => 'action', 'id' => "user_rates_list_search_btn", 'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
        $form['button_reset'] = array('name' => 'action', 'id' => "id_reset", 'content' => 'Clear', 'value' => 'cancel', 'type' => 'reset', 'class' => 'btn btn-line-sky pull-right margin-x-10');
    ...
    function user_alert_threshold(){
        ...
        $form['Low Balance Alert Email'] = array(
            array('', 'HIDDEN', array('name' => 'id'), '', '', '', ''),
            array('Enable Email Alerts ?', 'notify_flag', 'SELECT', '', '', 'tOOL TIP', '', '', '', '', 'custom_status'),
            array('Low Balance Alert Level', 'INPUT', array('name' => 'notify_credit_limit', 'size' => '20', 'class' => "text field medium"), 'valid_decimal', 'tOOL TIP', ''),
            array('Email Address', 'INPUT', array('name' => 'notify_email', 'size' => '50', 'class' => "text field medium"), 'valid_email', 'tOOL TIP', ''),
        );
        $form['button_save'] = array('name' => 'action', 'content' => 'Save', 'value' => 'save', 'type' => 'submit', 'class' => 'btn btn-line-parrot');
        return $form;
    }
    function build_cdrs_report($type) {
        ...
        if($type =='3'){
            $cost_array=array("Debit($currency)", "140", "cost", "cost", "cost", "convert_to_currency","","true","right");
        }
        $grid_field_arr = json_encode(array(
            ...
            array("Duration", "140", "billseconds", "user_cdrs_report_search", "billseconds", "convert_to_show_in","","true","center"),
            $cost_array,
    ...
    function build_cdrs_report_search($type) {
         if($type == '0' || $type =='1'){
            $cost_array=array('Debit ', 'INPUT', array('name' => 'debit[debit]', 'value' => '', 'size' => '20', 'class' => "text field "), '', 'Tool tips info', '1', 'debit[debit-integer]', '', '', '', 'search_int_type', '');
        }
        if($type =='3'){
            $cost_array=array('Debit ', 'INPUT', array('name' => 'cost[cost]', 'value' => '', 'size' => '20', 'class' => "text field "), '', 'Tool tips info', '1', 'cost[cost-integer]', '', '', '', 'search_int_type', '');
        }
    ...
    function build_user_refill_report(){
		...
		$currency=$this->CI->common->get_field_name('currency', 'currency', $currency_id);
         $grid_field_arr = json_encode(array(
            array("Date", "220", "payment_date", "", "", "","","true","center"),
            array("Amount($currency)", "220", "credit", "credit", "credit", "convert_to_currency","","true","right"),
            array("Refill By", "270", "payment_by", "payment_by", "payment_by", "get_refill_by","","true","center"),
            array("Note", "300", "notes", "", "", "","","true","center")
                ));
        return $grid_field_arr;
    }
    
    function build_user_refill_report_search() {       
        $form['forms'] = array("", array('id' => "user_refill_report_search"));
        $form['Search'] = array(
        array('From Date', 'INPUT', array('name' => 'payment_date[]', 'id' => 'customer_cdr_from_date', 'size' => '20', 'class' => "text field "), '', 'tOOL TIP', '', 'payment_date[payment_date-date]'),
        ...
        $form['button_search'] = array('name' => 'action', 'id' => "user_refill_report_search_btn", 'content' => 'Search', 'value' => 'save', 'type' => 'button', 'class' => 'btn btn-line-parrot pull-right');
        $form['button_reset'] = array('name' => 'action', 'id' => "id_reset", 'content' => 'Clear', 'value' => 'cancel', 'type' => 'reset', 'class' => 'btn btn-line-sky pull-right margin-x-10');
        return $form;
    }
    ...
    function build_user_fund_transfer_form($number, $currency_id, $id) {
        ...
        $form['Fund Transfer'] = array(
            ...
            array('From Account ', 'INPUT', array('name' => 'fromaccountid', 'size' => '20', 'value' => $number, 'readonly' => true, 'class' => "text field medium"), 'required', 'tOOL TIP', 'Please Enter account number'),
            array('To Account ', 'INPUT', array('name' => 'toaccountid', 'size' => '20', 'class' => "text field medium"), 'trim|required|numeric', 'tOOL TIP', 'Please Enter to account number'),
            array('Amount', 'INPUT', array('name' => 'credit', 'size' => '20',  'class' => "text field medium"), 'trim|required|numeric', 'tOOL TIP', ''),
            array('Note', 'TEXTAREA', array('name' => 'notes', 'size' => '20', 'cols' => '63', 'rows' => '5', 'class' => "form-control col-md-5  text field medium",'style'=>'height: 80px;'), '', 'tOOL TIP', '')
        );
    ...
    function build_user_opensips_buttons() {
        $buttons_json = json_encode(array(
	    array("Create", "btn btn-line-warning btn", "fa fa-plus-circle fa-lg", "button_action", "/user/user_opensips_add/", "popup"),
            array("Delete", "btn btn-line-danger", "fa fa-times-circle fa-lg", "button_action", "/user/user_opensips_delete_multiple/"),
        ));
        return $buttons_json;
    }
    ...
    $form['forms'] = array(base_url() . 'user/user_dids_action/edit/', array("id" => "user_did_form", "name" => "user_did_form"));
	  ...
	  array('DID', 'INPUT', array('name' => 'number', 'size' => '20', 'class' => "text field medium","readonly"=>"true"), 'trim|required|is_numeric|xss_clean|integer', 'tOOL TIP', 'Please Enter account number'),
	  array('Call Type', 'call_type', 'SELECT', '', '', 'tOOL TIP', '', '', '', '', 'set_call_type', ''),
	  array('Destination', 'INPUT', array('name' => 'extensions', 'size' => '20', 'class' => "text field medium"), 'trim|required|xss_clean', 'tOOL TIP', 'Please Enter Password'),
        );
        $form['button_save'] = array('name' => 'action', 'content' => 'Save', 'value' => 'save', 'type' => 'button', 'id' => 'submit', 'class' => 'btn btn-line-parrot');
        return $form;
