...
class user_model extends CI_Model
{
    ...
    function getuser_cdrs_list($flag, $start, $limit, $export = true)
    {
        ...
        if ($flag) {
            ...
            $this->db->select('callstart,sip_user,callerid,call_direction,callednum,pattern,notes,billseconds,disposition,debit,cost,accountid,pricelist_id,calltype,is_recording,trunk_id,uniqueid,uniqueid as uid, (select destination from ratedeck where id=did) as did');
        } else {
