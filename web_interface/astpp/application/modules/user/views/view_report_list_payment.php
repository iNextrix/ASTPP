...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        $("#cusotmer_cdr_payment_search_btn").click(function(){
            post_request_for_search("report_grid","<?php echo base_url(); ?>reports/user_paymentreport_search/","cdr_payment_search");
        });        
        $("#id_reset").click(function(){
            clear_search_request("report_grid","<?php echo base_url(); ?>reports/user_paymentreport_clearsearchfilter/");
        });
    });
</script>
<? endblock() ?>
