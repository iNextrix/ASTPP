   	    ...
   	    <div class="row">
			...
			<div class="col-md-12 w-box">
				<div class="breadcrumb">
					<a href="<?= base_url(); ?>user/user_myprofile/">My Profile</a>
					<a href="<?= base_url(); ?>user/user_myprofile/">Email Setting</a>
				</div>
				...
				<div class='col-md-6'>
					<div class='col-md-4'><label>SMTP port:</label></div>
				...
				<input type="hidden" name='id' id='id' value="<?= $account_data[0]['id'] ?>">
				<div class='col-md-6'>
					<div class='col-md-4 '><label>SMTP:</label></div>
					<div class='col-md-6'>
				...
				<div class='col-md-6'>
					<div class='col-md-4'><label>SMTP user:</label></div>
				...
				<input type="hidden" name='id' id='id' value="<?= $account_data[0]['id'] ?>">
				<div class='col-md-6'>
					<div class='col-md-4 '><label>SMTP host:</label></div>
				...
				<div class='col-md-6'>
					<div class='col-md-4'><label>SMTP password:</label></div>
