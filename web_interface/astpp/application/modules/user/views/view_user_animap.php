        ...
        <div class="row"> 
            <div class="col-md-12 no-padding color-three border_box"> 
			    ...
			    <li><a href="#"><?php echo gettext('Configuration')?></a></li>
					...
					?>
                        ...
                        <li class='active'>
                           <a href="<?= base_url() . "user/user_animap_list/"; ?>"><?php echo gettext('Caller ID')?></a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="padding-15 col-md-12">
                <div class="col-md-12 no-padding">
                    <div class="pull-left margin-b-10" id="left_panel_add">
                ...
                <div class="margin-b-10 slice color-three pull-left content_border col-md-12" id="left_panel_form" style="cursor: pointer; display: none;">
                    <fieldset class="margin-b-20">
                        ...
                        <form method="post" name="ani_map" id="ani_map" action="<?= base_url() ?>user/user_animap_action/add/" enctype="multipart/form-data">
                            <div class='col-md-12'>
