...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        build_grid("ccbrand_grid","",<? echo $grid_fields; ?>,<? echo $grid_buttons; ?>);
        
        $("#ccbrands_search_btn").click(function(){
            post_request_for_search("ccbrand_grid","","ccbrand_search");
        });        
        $("#id_reset").click(function(){
            clear_search_request("ccbrand_grid","");
        });
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">                        
    <div class="portlet-header ui-widget-header">CC Brand List
        <span id="error_msg" class=" success"></span>
        <span class="ui-icon ui-icon-circle-arrow-s"></span></div>
    <div class="portlet-content">         
        <form method="POST" action="del/0/" enctype="multipart/form-data" id="ListForm">
            <table id="ccbrand_grid" align="left" style="display:none;"></table>
        </form>
    </div>
</div>  
