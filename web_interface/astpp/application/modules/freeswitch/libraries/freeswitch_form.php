    ...
    function fsdevice_form_fields_for_customer($accountid, $id = false)
    {
        ...
        if ($id > 0) {
            ...
            $password_field = array(
                ...
                'tOOL TIP',
                'Please Enter Password',
                '<i style="cursor:pointer; font-size: 17px; position:absolute; right:20px; bottom: 7px;" title="" class="change_pass align-self-end text-success fa fa-refresh" ></i>'
            );
            $user_name = array(
                gettext('Username'),
                'INPUT',
                ...
                'tOOL TIP',
                'Please Enter account number',
                '<i style="cursor:pointer; font-size: 17px; position:absolute; right:20px; bottom: 7px;" title="" class="change_number align-self-end text-success fa fa-refresh" ></i>'
            );
        }
