...
$(document).ready(function() {
 ...
 colModel : [
		...
		{display: '<?php echo gettext("Org.<br/>Prefix"); ?>', name: 'Org. Prefix', width: 60, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Org.<br/>Destination"); ?>', name: 'Org. Destination', width: 90, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Org.<br/>Cost"); ?>', name: 'Org. Cost', width: 80, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Term.<br/>Trunk"); ?>', name: 'Term. Trunk', width: 80, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Term.<br/>Prefix"); ?>', name: 'Term. Prefix', width: 60, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Term.<br/>Destination"); ?>', name: 'Term. Destination', width: 80, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Term.<br/>Cost"); ?>', name: 'Term. Cost', width: 80, sortable: true, align: 'center'},
		...
		{display: '<?php echo gettext("Read/Write<br/>codecs"); ?>', name: 'Codecs', width: 200, sortable: true, align: 'center'}
		],
	nowrap: false,
	showToggleBtn: false,
	sortname: "id",
