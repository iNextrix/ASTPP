...
$(document).ready(function() {
 ...
 colModel : [
		...
		{display: '<?php echo gettext("Term.")?><br/> <?php echo gettext("Trunk"); ?>', name: 'Term. Trunk', width: 80, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Term.")?><br/><?php echo gettext("Prefix"); ?>', name: 'Term. Prefix', width: 60, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Term.")?><br/> <?php echo gettext("Destination"); ?>', name: 'Term. Destination', width: 80, sortable: true, align: 'center'},
		{display: '<?php echo gettext("Term.")?><br/> <?php echo gettext("Cost"); ?>', name: 'Term. Cost', width: 80, sortable: true, align: 'center'},
