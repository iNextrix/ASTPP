...
$(document).ready(function() {
  ...
  jQuery('#sip_port').removeClass('borderred');
   ...
   function validateForm(){
      ...
      {
		  document.getElementById('name_error').innerHTML = "<i style='color:#D95C5C; padding-right: 6px; padding-top: 10px;' class='fa fa-exclamation-triangle'></i><span class='popup_error error  p-0'>Name is Required.</span>";
		  document.getElementById('sip_name').focus();
		  jQuery('#sip_name').addClass('borderred');
		  formflag = false;
      }
      if(document.getElementById('sip_port').value == ""){
		  document.getElementById('error_msg_port').innerHTML = "<i style='color:#D95C5C; padding-right: 6px; padding-top: 10px;' class='fa fa-exclamation-triangle'></i><span class='popup_error error  p-0'>The SIP Port field is Required.</span>";
		  document.getElementById('sip_port').focus();
		  jQuery('#sip_port').addClass('borderred');
		  formflag = false;
	  }
...
function validate_setting(){
	 ...
	 if(document.getElementById('params_name').value.trim() == ""){
		 document.getElementById('params_name_error').innerHTML = "<i style='color:#D95C5C; padding-right: 6px; padding-top: 10px;' class='fa fa-exclamation-triangle'></i><span class='popup_error error  p-0'>Name is Required.</span>";
