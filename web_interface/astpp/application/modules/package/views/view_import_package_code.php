        	...
        	<div class="row">
              <div class="col-md-12">
               ...
               <div class="col-md-12  no-padding">
               	  <div class="col-md-6">
                     <div class="w-box">
                       <h3 class="padding-t-10 padding-l-16 padding-b-10">Import Package Codes:</h3>
                           <div class="col-md-12 no-padding">
                           ...
                           <div class="col-md-12 no-padding">
                            ...
                            <input type="hidden" name="username" value="<?= $this->session->userdata('username') ?>" />
                               ...
                               <div class="fileinput fileinput-new input-group" data-provides="fileinput">
	                               ...
	                               <input style="height:33px;" name="package_code_import"   id="package_code_import" type="file"></span>
                               </div>
                               </div>
                    ...
                    <div class="col-md-6">
                     <div class="w-box padding-b-10">
                       <div class="col-md-12 padding-t-20">
                               ...
                               <div><a href="<?= base_url(); ?>package/package_patterns_download_sample_file/packagecode_sample" class="btn btn-success">Click Here</a></div>
                           </div>
                   </div>                    
                   </div>
               </div>
