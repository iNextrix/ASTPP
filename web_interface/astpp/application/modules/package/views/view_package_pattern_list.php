        ...
        <div class="row"> 
            ...
            <div class="padding-15 col-md-12">
                <div class="col-md-12 no-padding">
                    ...
                    <div id="left_panel_delete" class="pull-left margin-t-10 padding-x-4" onclick="delete_multiple('/package/package_patterns_selected_delete/')">
                    ...
                    <div id="show_search" class="pull-right margin-t-10 col-md-4 no-padding">
                        <input type="text" name="left_panel_quick_search" id="left_panel_quick_search" class="col-md-5 form-control pull-right" value="<?php echo $this->session->userdata('left_panel_search_package_patterns') ?>" placeholder="Search"/>
                    </div>
                </div>    

                <div id="package_patterns">
                    <div class="col-md-12 color-three padding-b-20">
                        <table id="package_pattern_list" align="left" style="display:none;"></table>  
                    </div>
                </div>
            </div>   
        </div>
