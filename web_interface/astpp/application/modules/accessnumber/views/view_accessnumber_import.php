...
<script>
  $(document).ready(function() {
    $("#ok").click(function(){
      window.location='/accessnumber/accessnumber_list/';
    });
  });
</script>
...
<section class="slice color-three padding-t-20">
	<div class="w-section inverse no-padding">
		<div class="container">
			<div class="row">
				<form method="post"
					action="<?= base_url() ?>accessnumber/accessnumber_bulk_import"
            ...
            ?></div>
					...
					<div class="col-md-12 padding-b-10">
						<div class="pull-right">
							<a href="<?= base_url().'accessnumber/accessnumber_list/'?>"><input
	...
	<div class="portlet-content">
		<form method="post"
			...
			<input type="hidden" name="logintype"
				...
				name="accessnumberimport" size="40" />
