...
<div id="content" class="container-fluid">
	...
	<div id="floating-label" class="card pb-4">
		<form class="row px-4" id="purchase_did_form"  name='purchase_did_form' method="post" action="<?= base_url() ?>did/did_reseller_purchase/" enctype="multipart/form-data">
			...
			<?php
				  $where = array("status"=>0,"deleted"=>0,"type"=>0,"reseller_id"=>$account_id);
								$account_arr = array("id" => "account_id", "name" => "account_id", "class" => "account_id");
...
<section class="slice color-three pb-4">
  <div class="w-section inverse p-0">
				...
				<?php if(isset($permissioninfo['did']['did_list']['buy_did'])  and $permissioninfo['did']['did_list']['buy_did'] == 0 and ($permissioninfo['login_type'] == '1' or $permissioninfo['login_type'] == '2' or $permissioninfo['login_type'] == '4')){
				     ?>
				<input type="submit" class="btn btn-info mb-4" name="purchase_did" value="Buy DIDs" id="buy_did">    
				<?php } ?>
				</form>
