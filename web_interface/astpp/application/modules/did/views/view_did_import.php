...
<section class="slice color-three">
	<div class="w-section inverse p-0">
		<div class="container">
			<div class="row">
				<form method="post" action="<?= base_url() ?>did/did_bulk_import"
...
if (isset($error) && ! empty($error)) {
                   ...
                   <?php echo gettext("number,account,connectcost,includedseconds,monthlyfee,cost,extensions,status,provider,country,province,city,increment"); ?>
                <br />
...
$trunklist = form_dropdown('trunk_id', $this->db_model->build_dropdown("id,name", "trunks", "", ""), '');
                            ...
                            ?></div>
								...
								<div class="col-md-12 no-padding" s>
									<input type="hidden" name="mode" value="Import DIDs" /> <input
						...
						<div class="col-md-6">
							<div class="w-box padding-b-10">
								...
								<div class="col-md-12 no-padding">
									...
									<div>
										<a href="href='<?= base_url(); ?>/did/did_list/'"
					...
					<div class="col-md-12 padding-b-10">
						<div class="pull-right">
							<a href="<?= base_url().'did/did_list/'?>"><input
								class="btn btn-three" id="ok" type="button" name="action"
								value=<?php echo gettext("Cancel"); ?> /></a> <input
								class="btn btn-primary" id="impoddrt_termination1" type="submit"
...
<div
	...
	<div class="portlet-content">
		<form method="post" action="<?= base_url() ?>did/did_bulk_import"
			...
			<br /> <input type="hidden" name="mode" value="Import DIDs" /> <input
				type="hidden" name="logintype"
				value="<?= $this->session->userdata('logintype') ?>" /> <input
				type="hidden" name="username"
				value="<?= $this->session->userdata('username') ?>" /> <label
