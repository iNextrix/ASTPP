...
<? startblock('page-title') ?>
    <?=$page_title;?> <?//= isset($pricelistid)?$this->common->get_field_name('name', 'pricelists',$pricelistid):"";?><? //= $page_title ?><br/>
<? endblock() ?>
<? startblock('content') ?>  
              ...
              <div class="col-md-12">
            	<div class="w-box">
            	 <span  style="margin-left:10px; text-align: center;background-color: none;color:#1c8400;">
                   ...
                   <h3 class="padding-t-10 padding-l-16">File must be in the following format:</h3>
            <p>Number,Account Number,Calltype,Destination,Country,Connect cost,Included seconds,Monthlyfee,cost,Increment</p>
                 </div>
               </div>
               <div class="col-md-12  no-padding">
				...
				<input  class="text field large" type="file" name="didimport"  size="80" id="didimport" style="height:33px;"/></div></span>
                           ...
                           <label class="col-md-3">Check Header:</label>
                                <div class="col-md"><input type='checkbox' name='check_header'/></div>
                     </div>
                   </div>
                   <div class="col-md-6">
