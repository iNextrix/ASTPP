            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="w-box">
                     ...
                     <p>Account, Password, First Name,Last Name,Company,Phone,Mobile,Email,Address,city,Province/State,Zip/Postal Code,Number Translation,Out Callerid Translation,In Callerid  Translation,Concurrent Calls,CPS,SIP Username,SIP Password</p>
                  </div>
               </div>
               <div class="col-md-12">
                  <div class="col-md-8">
                        ...
                        <div class="no-padding">
                           ...
                           <div class="col-md-6">
							   <div class='col-sm-12 form-inline form-group'>
								...
								<div class='col-sm-12 form-inline form-group'>
									<div class='col-sm-6'>
										<label class="control-label">Select the file : </label>	 
									</div>
									<div class='col-sm-6'>
                           ...
                           <div class="col-md-6">
								...
								<div class='col-sm-12 form-inline form-group'>
									...
									<div class='col-sm-4'>
										<?php echo $config_array['credit_limit']; ?>
									</div>
								</div>
								<div class='col-sm-12 form-inline form-group'>
									<div class='col-sm-6'>
                        ...
                        foreach($mapto_fields['general_info'] as $csv_key => $csv_value) {
								...
								<?php
									...
									for ($i = 0; $i < count($file_data); $i++) { ?>
										<option value="<?php echo $file_data[$i]; ?>"><?php echo $file_data[$i]; ?></option>
								<?php
									}
									echo "</td>";
									echo "</tr>";
