...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        build_grid("product_cus_grid","",<? echo $grid_fields; ?>,'');
	...
	$("#productlist").change(function(){ 
		...
		$('#parent_product').attr('action', "<?php echo base_url();?>products/products_list/");
	...
	<div class="col-md-12">
		 <div class='col-md-4 py-4 px-0 float-right'>
		 	<select name="productlist" id="productlist" class="col-md-12 form-control selectpicker form-control-lg" data-live-search='true' datadata-live-search-style='begins'>
		 		<option value='0' ><?php echo gettext("My Product");?></option>
		 		<option value='1' <?php echo "selected"; ?>><?php echo gettext("Parent Product");?></option>
		 	</select>	      
		 </div>
	 </div>
 </div>
