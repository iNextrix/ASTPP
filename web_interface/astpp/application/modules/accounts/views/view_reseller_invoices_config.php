...
$(function() {
	...
	var url='<?php echo base_url()."accounts/reseller_invoice_logo_delete/"; ?>'+id;
	...
	if(answer){
		$.ajax({
			...
			success: function(response){
				window.location = '<?php echo base_url()."accounts/reseller_invoice_config/"; ?>'+id;
			}
		});
	}else{
		return false;
...
<div id="main-wrapper" class="tabcontents">   
    <div id="content">   
		...
		<form method='POST' id="reseller_form" name="reseller_form" action="<?= base_url()?>accounts/reseller_invoice_config/" enctype="multipart/form-data">
		...
		<div class='col-md-12 no-padding'>
			<div class='col-md-6'>
				...
				<div class='col-md-6'><input type='text' name="domain" value="<?= $account_data['domain'] ?>" class="col-md-12 form-control"></div>
			</div>
			<div class='col-md-6'>
				<div class='col-md-4  no-padding'><label>Website Header:</label></div>
				<div class='col-md-6'><input type='text' name="website_title" value="<?= $account_data['website_title'] ?>" class="col-md-12 form-control"></div>
			</div>
		</div>	
		<div class='col-md-12 no-padding'>
			<div class='col-md-6'>
				<div class='col-md-4 '><label>Website Footer:</label></div>
				<div class='col-md-6'><input type='text' name="website_footer" value="<?= $account_data['website_footer'] ?>" class="col-md-12 form-control"></div>
			</div>
			<div class='col-md-6'>
