...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        build_grid("charges_grid","<?php echo base_url()."accounts/customer_details_json/charges/$edit_id/"; ?>",<?php echo $grid_fields ?>,"");
            ...
            <div class="padding-15 col-md-12">
                <div class="col-md-12 no-padding">
                    <div id="show_search" class="pull-right margin-t-10 col-md-4 no-padding">
                        <input type="text" name="left_panel_quick_search" id="left_panel_quick_search" class="col-md-5 form-control pull-right" value="<?php echo $this->session->userdata('left_panel_search_'.$accounttype.'_charges')?>" placeholder="Search"/>
                    </div>
                </div> 
                <div class="col-md-12 no-padding">
