...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        build_grid("languages_grid","",<? echo $grid_fields; ?>,<? echo $grid_buttons; ?>);
        $('.checkall').click(function () {
          $('.chkRefNos').prop('checked', $(this).prop('checked'));
        });
        $("#languages_search_btn").click(function(){
            
            post_request_for_search("languages_grid","","languages_search");
        });        
        $("#id_reset").click(function(){ 
            clear_search_request("languages_grid","");
        });
	...
	<div class="w-section inverse p-0">
    	        <div class="card col-md-12 pb-4">      
                        <form method="POST" action="del/0/" enctype="multipart/form-data" id="ListForm">
                            <table id="languages_grid" align="left" style="display:none;"></table>
                        </form>
                </div>  
    </div> 
</section>
