...
$("#reseller_sum_report_grid").flexigrid({
    url: "<?php echo base_url();?>reports/reseller_sum_Report/",
    method: 'GET',
    dataType: 'json',
	colModel : [
...
//        {display: 'Actual',width:80, name: 'provider',  sortable: false, align: 'center'},
    ...
    $("#id_reset").click(function(){
        window.location="<?=base_url()?>reports/reseller_clear_search_sum_Report/";
    });
...
{
    $('#reseller_sum_report_grid').flexReload();
}
</script>	
     ...
     <script>
	  $(document).ready(function() {
        ...
        <div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">                        
         ...
         <form action="<?=base_url()?>reports/reseller_summery_Report" id="search_form22" name="form22" method="POST" enctype="multipart/form-data" style="display:block">
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">                        
    ...
    <div class="portlet-content">         
		<form method="POST" action="del/0/" enctype="multipart/form-data" id="ListForm">
			<table id="reseller_sum_report_grid" align="left" style="display:none;"></table>
		</form>
	</div>
</div>  
    <? endblock() ?>	
