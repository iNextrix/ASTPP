...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        build_grid("providersummary_grid","",<?php echo $grid_fields; ?>,<?php echo $grid_buttons; ?>);
...
<script>
    $(document).ready(function() {
        jQuery("#provider_from_date").datetimepicker({format:'Y-m-d H:i:s'});		
        ...
        <div class="container">
            <div class="row">
                <div class="portlet-content"  id="search_bar" style="cursor:pointer; display:none">
                    <form action="<?php echo base_url(); ?>/summary/provider_search/" method="post" accept-charset="utf-8" id="providersummary_search" name="providersummary_search">
                        <ul class='padding-16'>
                            <fieldset>
...
?>
                                ...
                                <div class="col-md-4 no-padding">
                                    <label class="search_label col-md-12 no-padding">Trunk</label>
...
?>
                                ...
                                <button name="action" type="button" id="providersummary_search_btn" value="save" class="btn btn-line-parrot pull-right" >Search</button>
