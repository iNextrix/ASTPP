...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        build_grid("resellersummary_grid","",<?php echo $grid_fields; ?>,<?php echo $grid_buttons; ?>);
...
<script>
    $(document).ready(function() {
        jQuery("#reseller_from_date").datetimepicker({format:'Y-m-d H:i:s'});		
        ...
        <div class="container">
            <div class="row">
                <div class="portlet-content"  id="search_bar" style="cursor:pointer; display:none">
                    <form action="<?php echo base_url(); ?>/summary/reseller_search/" method="post" accept-charset="utf-8" id="resellersummary_search" name="resellersummary_search">
                        <ul class='padding-16'>
                            <fieldset>
                        ...
                        <ul class='padding-16'>
                            <fieldset>
                             ...
                             <div class="col-md-12 margin-t-20 margin-b-20">
                                ...
                                <button name="action" type="button" id="resellersummary_search_btn" value="save" class="btn btn-line-parrot pull-right" >Search</button>
