...
class Common_model extends CI_Model {
	...
	function get_dashboard_details() {
		...
		$data['version_name'] = ($this->config->item('edition') == "E") ? "Enterprise" : "Community";
		$data['version_number'] = Common_model::$global_config['system_config']['version'];
		if ($data['version_name'] == "Enterprise") {
			$build_dir = file_get_contents(getcwd() . "/.build");
			$build_data = ($build_dir != "") ? explode("=", $build_dir) : "";
			$data['build_name'] = ($build_data != "") ? $build_data[1] : "";
		}
