...
function get_cdr_string($dataVariable,$accountid,$account_type,$actual_duration,$termination_rate,$origination_rate,$provider_cost,$parentid,$debit,$cost,$logger)
{
		...
		$DialNumber = isset($dataVariable['caller_did_account_id']) && $dataVariable['caller_did_account_id']==$accountid ? $dataVariable['sip_to_user'] : $dataVariable['effective_destination_number'];
		$logger->log("Dial Number ".$DialNumber." receiver_accid ".$dataVariable['caller_did_account_id']." accountid : ".$accountid);
